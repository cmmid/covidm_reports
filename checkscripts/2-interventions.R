...
params$pop[[1]]$dist_seed_ages = cm_age_coefficients(20, 50, 5 * (1:length(params$pop[[1]]$size) - 1)) # infections start in individuals aged 20-50
...
ggplot(run$dynamics[compartment == "cases"]) +
    ...
    facet_wrap(~population) + scale_y_log10()
