...
The panels in Fig. \@ref(fig:tsunmit) show aggregate and by-age group outcomes for daily incidence of cases and deaths, and daily demand for hospital care. The quantiles for peak timing and values for those outcomes is summarised in Table \@ref(tab:unpeakstable).

```{r tsunmit, fig.height=4, fig.cap="Unmitigated time series."}
...
The panels in Fig. \@ref(fig:tsintervention) compare unmitigated and intervention aggregate and by-age group outcomes for daily incidence of cases and deaths, and daily demand for hospital care. The quantiles for peak timing and values for those outcomes is summarised in Table \@ref(tab:intpeakstable).

```{r tsintervention, fig.height=4, fig.cap="Intervention time series."}
pks <- alls.dt[age=="all",{
  res <- apply(.SD, 2, max)
  names(res) <- colnames(.SD)
  as.list(res)
