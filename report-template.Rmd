...
- We estimate predicted peak counts and timing for `r params$location` in incident symptomatic cases, deaths and daily hospital bed need, and calculate the impact of the interventions relative to an unmitigated epidemic.
...
**All numerical results are reported to two significant figures only, and reported as interquartile and 95% intervals.**
...
parameter_set_df <- data.frame(matrix(c(
  "Basic reproductive rate", "$R_0$", "Normal", "$\\mu = 2.6$", "1.6–3.9", "\\citep{davies2020}",
  "Age-specific clinical fraction", "$y_i$", "Fixed", "Age-dependent", "0.3-0.8", "\\citep{daviesage2020}",
  "Relative infectiousness\nof subclinical cases", "$f$", "Fixed", "50\\%", "0.5", "Assumed",
  ...
  "Risk of becoming a severe case", "hosp", "Fixed", "Age-dependent", "0.0-61.8", "\\citep{davies2020, vzandvoort2020}",
  "Proportion hospitalised who are critical", "l", "Fixed", "30\\%", "0.3", "\\citep{liu2020contribution, vzandvoort2020}",
  "Case fatality ratio severe cases", "CFRs", "Fixed", "Age-dependent", "0.0-11.5", "\\citep{davies2020, vzandvoort2020}",
  "Case fatality ratio critical cases", "CFRc", "Fixed", "75\\%", "0.75", "assumed"
),
ncol = 6, byrow = TRUE
))
