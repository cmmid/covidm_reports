...
```{r echo=FALSE}
parameter_set_df <- data.frame(matrix(c("Basic reproductive rate", "$R_0$", "Sampled PERT distribution", "$\\mu = 0.5$", "1.6–3.9", "References list",
                                        "Age-specific clinical fraction", "$y_i$", "Fixed", "Age-dependent", "0.1-0.2", "[@davies_age_2020]",
                                        "Relative infectiousness of subclinical cases", "$f$", "Fixed", "$0.5*y_i$", "0.1-0.5", "[@davies_age_2020]",
                                        "Case fatality ratio", "CFR", "Normal", "$\\mu = 0.5$", "0.001-0.077", "References list",
                                        "Serial interval", "SI", "Normal", "$\\mu = 6.5$days", "1.6–3.9", "[@li2020early;@bi2020epidemiology;@nishiura2020serial]",
                                        "Length of preclinical period", "l", "Fixed", "30\\%", "0.3", "[@liu2020contribution]",
                                        "Mean latent period", "p", "Fixed", "4 days", "4", "[@liu2020contribution]",
                                        "Mean duration of preclinical infectiousness", "$d_p$", "Fixed", "1.5 days", "1.5", "[@liu2020contribution]",
                                        "Mean duration of clinical infectiousness", "$d_c$", "Fixed", "3.5 days", "1.5", "[@liu2020contribution]",
                                        "Mean latent period", "p", "Fixed", "4 days", "4", "[@liu2020contribution]"), 
                                      ncol = 6, byrow = TRUE))
names(parameter_set_df) <- c("Short English Name", "Abbreviation", "Assumed Distribution", "Distribution Parameters", "95\\% CI", "References")
kableExtra::kable(parameter_set_df, "markdown", booktabs=TRUE, escape=FALSE)# %>% 
